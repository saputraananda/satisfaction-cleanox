...
<body class="min-h-screen flex items-start sm:items-center justify-center p-4 py-8 relative">
  ...
  <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md px-8 py-10 animate-card-in relative z-10">
    ...
    <div class="grid grid-cols-2 gap-3 mb-6 animate-fade-up" style="animation-delay:.35s">
      ...
      <div class="rounded-2xl p-4 border" style="background:#F6F1F7;border-color:#E9D5EA;">
        ...
        <div class="flex items-end gap-1.5">
          ...
          <div>
            <p class="text-2xl font-bold text-gray-800 leading-none"><?= $csat ?><span
                class="text-sm font-semibold text-gray-400">/5</span></p>
        ...
        <div class="flex gap-0.5 mt-2">
          <?php for ($s = 1; $s <= 5; $s++): ?>
            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"
              style="color:<?= $s <= $csat ? '#F59E0B' : '#E2E8F0' ?>;">
              <path
                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
          <?php endfor; ?>
      ...
      <div class="rounded-2xl p-4 border" style="background:<?= $cat['bg'] ?>;border-color:<?= $cat['border'] ?>;">
        ...
        <div class="flex items-end gap-1.5">
          ...
          <div>
            <p class="text-2xl font-bold text-gray-800 leading-none"><?= $nps ?><span
                class="text-sm font-semibold text-gray-400">/10</span></p>
    ...
    <div class="animate-fade-up mb-7" style="animation-delay:.4s">
      <div class="rounded-2xl px-5 py-3.5 flex items-center gap-3 border"
